...
DT::datatable(head(data,6))

h4('Last 6 Observations')
DT::datatable(tail(data,6))
```
...
We have a very slight positive correlation between ABV and IBU, with a coefficient of `r round(model$coefficients[[2]]*100,digits=3)` of increase % Alcohol per IBU point

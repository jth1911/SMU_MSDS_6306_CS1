...
We have a positive correlation between Population and number of Breweries in each Stte, with a coefficient of `r comma(model$coefficients[[2]])` people per each new Brewery

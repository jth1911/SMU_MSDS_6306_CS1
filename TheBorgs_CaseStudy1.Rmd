...
DT::datatable(head(data,6)
              ...
              ,options=list(scrollX=T
                            ,autoWidth = TRUE #allow custom width
                            ,columnDefs = list(list(width = '100px', targets = c(1))  #width for beer name
                                               ,list(width = '150px', targets = c(5,7)) #width for style and brewer
                            )
              ))
